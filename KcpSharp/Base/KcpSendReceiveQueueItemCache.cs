...
using LinkedListNodeOfQueueItem =
    System.Collections.Generic.LinkedListNode<(NahidaImpact.KcpSharp.Base.KcpBuffer Data, byte Fragment
        )>;
using LinkedListOfQueueItem =
    System.Collections.Generic.LinkedList<(NahidaImpact.KcpSharp.Base.KcpBuffer Data, byte Fragment)>;
#endif
